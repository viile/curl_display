...
const messages: Messages = {
  ...
  messages: {
    ...
    requestAborted: 'Requisição interrompida',
  },
  ...
  result: {
    ...
    running: 'Executando...',
    runningHint: 'Clique em "Parar" ou pressione Esc para abortar a requisição',
    metaTime: 'Tempo',
    metaSize: 'Tamanho',
    metaType: 'Tipo',
    metaExit: 'Saída',
  ...
  favorites: {
    title: 'Favoritos',
    empty: 'Sem favoritos ainda — toque ☆ em um item do histórico para adicionar',
  },
  ...
  decode: {
    ...
    empty: 'Nenhum parâmetro decodificável neste comando',
    sectionQuery: 'Parâmetros de consulta URL',
    sectionHeaders: 'Cabeçalhos',
    sectionCookies: 'Cookies',
    sectionForm: 'Campos de formulário (-F)',
    sectionData: 'Corpo da requisição',
    colKey: 'Chave',
    colValue: 'Valor',
    colRaw: 'Original',
    ...
    copied: 'Copiado',
    close: 'Fechar',
    parseErrorTitle: 'Falha ao analisar',
