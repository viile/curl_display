...
const messages: Messages = {
  ...
  result: {
    ...
    searchPlaceholderRegex: 'Per Regex suchen…',
    regexToggle: 'Regulären Ausdruck verwenden',
    regexInvalid: 'Ungültiger Regex',
    searchTargetLabel: 'Suchziel',
    searchTargetAll: 'Alle',
    searchTargetKey: 'Schlüssel',
  ...
  decode: {
    title: 'curl-Dekoder',
    empty: 'Keine dekodierbaren Parameter in diesem Befehl',
    sectionQuery: 'URL-Abfrageparameter',
    sectionHeaders: 'Header',
    sectionCookies: 'Cookies',
    sectionForm: 'Formularfelder (-F)',
    sectionData: 'Anfragetext',
    colKey: 'Schlüssel',
    colValue: 'Wert',
    colRaw: 'Roh',
    colDecoded: 'Dekodiert',
    colHeaderName: 'Name',
    colHeaderValue: 'Wert',
    copyUrl: 'URL kopieren',
    copyRaw: 'Rohwert kopieren',
    copyAll: 'Alle kopieren',
    copied: 'Kopiert',
    close: 'Schließen',
    parseErrorTitle: 'Analyse fehlgeschlagen',
