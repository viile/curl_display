...
const messages: Messages = {
  ...
  messages: {
    ...
    requestAborted: 'Запрос остановлен',
  },
  ...
  result: {
    ...
    running: 'Выполняется...',
    runningHint: 'Нажмите «Остановить» или Esc, чтобы прервать запрос',
    metaTime: 'Время',
    metaSize: 'Размер',
    metaType: 'Тип',
    metaExit: 'Код выхода',
  ...
  favorites: {
    title: 'Избранное',
    empty: 'Пока нет избранного — нажмите ☆ на элементе истории, чтобы добавить',
  },
